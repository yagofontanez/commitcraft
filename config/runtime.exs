...
#
#     PHX_SERVER=true bin/commitcraft start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :commitcraft, CommitCraftWeb.Endpoint, server: true
end
  ...
  config :commitcraft, CommitCraftWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/commitcraft_web/router\.ex$"E,
        ~r"lib/commitcraft_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
